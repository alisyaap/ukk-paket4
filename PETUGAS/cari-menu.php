                    ...
                    <div class="table-responsive">
                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td><a type='button' href='?page=edit-brg&id_produk=<?= $data['id_produk']; ?>' class='btn btn-sm btn-warning'>Edit</a>/<a type='button' href='?page=hapus-brg&id_produk=<?= $data['id_produk']; ?>' class='btn btn-sm btn-danger'>Delete</a></td>
